...
- API version: 1.0.0
  - Build date: 2022-09-25T10:14:38.415981Z[Etc/UTC]
...
<dependency>
  ...
  <version>0.202209251212.0</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "io.gitlab.buziproject:buzi:0.202209251212.0"
  }
```
...
* `target/buzi-0.202209251212.0.jar`
* `target/lib/*.jar`
